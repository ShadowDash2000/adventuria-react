...
export const CollectionOneFilterContext = createContext({} as CollectionOneFilterProviderType<RecordModel>);
...
export const CollectionOneFilterProvider = <T extends RecordModel>(
    ...
    return <CollectionOneFilterContext.Provider value={{data}}>
        {children}
    </CollectionOneFilterContext.Provider>
}

export const useCollectionOneFilter = <T extends RecordModel>() => useContext<CollectionOneFilterProviderType<T>>((CollectionOneFilterContext as unknown) as Context<CollectionOneFilterProviderType<T>>);